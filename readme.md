...
```bash
dotnet add package SuperTokensSDK.Net --version 2.4.0
```

Or via the Package Manager Console:

```powershell
Install-Package SuperTokensSDK.Net -Version 2.4.0
```

Or in the .csproj:

```xml
<PackageReference Include="SuperTokensSDK.Net" Version="2.4.0" />
```
